...
class UserAdapter:
    ...
    Aprende preferencias personales y las aplica en futuras predicciones.
    """
    
    def __init__(self, user_id: str):
        self.user_id = user_id
        self.word_frequency = {}  # {palabra: frecuencia}
        self.selection_history = []  # Lista de selecciones
    ...
    def register_selection(self, context: str, selected_word: str):
        """
        Registra cuando el usuario selecciona una palabra sugerida.
        """
        # Actualizar frecuencia de palabra
    ...
    def increment_prediction_count(self):
        """Incrementa contador de predicciones realizadas."""
